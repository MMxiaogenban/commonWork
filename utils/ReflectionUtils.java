...
public class ReflectionUtils {
	...
	public static <T> T trimStrFieldsToNull(T bean, String... ignoreFields) {
		if (bean == null) {
			return bean;
		}
		...
		for (Field field : fields) {
			...
			if (String.class.equals(field.getType())) {
				...
				if(null != val) {
					final String trimVal = StringUtils.trimToNull(val);
					if (!StringUtils.equals(val, trimVal)) {
				...
				if(val instanceof Collection) {
					final Collection<?> filterVal = CollectionUtil.removeNull((Collection<?>)val);
					if(!CollectionUtils.isEqualCollection((Collection<?>)val, filterVal)) {
						ReflectUtil.setFieldValue(bean, field, filterVal);
					}
				}else if(val instanceof Object[]) {
					final Object[] filterVal = ArrayUtil.removeNull((Object[])val);
					if(!ArrayUtils.isEquals((Object[])val, filterVal)) {
						ReflectUtil.setFieldValue(bean, field, filterVal);
					}
				}
			}  
